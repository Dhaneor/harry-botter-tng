...
# -*- coding: utf-8 -*-
"""
Provides different types of plots/charts.

Most of these classes can be used but are more or less unnnecessary
after the PlotMixin has been introduced. The most important components
can be plotted directly now by calling the .plot() method of the plot 
object.
...
from .chart_artist import ChartArtist
