...
class RequestFactory:
    ...
    # --------------------------------------------------------------------------
    def prepare_requests(self, target_account: List[dict], all_assets: Iterable[str]):
        ...
        for asset in all_assets:
            ...
            self._requests[asset] = self._build_request_object(asset, target_request)
    ...
    def _build_request_object(
        self, asset: str, target: Union[dict, None]
        ...
        if target:
            ...
            return PositionChangeRequest(asset=asset, quote_asset=self.quote_asset)
