...
from exchange.util.kucoin_async.client import Trade
from util.timeops import get_start_and_end_timestamp
...
class KucoinOrderDownloader:
    ...
    async def get_orders(
        ...
        for p in periods:
            ...
            tasks.append(create_task(self._get_orders_for_one_period(**kwargs)))
    ...
    async def _get_orders_for_one_period(
        self, *args, **kwargs
    ...
    def _get_download_periods(
        self, start: Union[str, int], end: Union[str, int]
    ) -> tuple:
    ...
    def _get_start_and_end_timestamp(
        self, start: Union[str, int], end: Union[str, int]
    ) -> tuple:
