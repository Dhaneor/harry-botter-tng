...
def _get_market_order():
    return {
        "clientOrderId": "66fa60d0-9369-11ec-a2cd-1e00623eee81",
...
def _get_stop_limit_order():
    return {
        "clientOrderId": "RV9SRdlQvatep1nsNX64vH",
...
def human_order_response(response: dict) -> str:
    ...
    price = round(quote_qty / base_qty, _precision) if base_qty > 0 else 0.0
