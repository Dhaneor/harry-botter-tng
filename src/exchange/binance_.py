...
class call_wrapper:
    ...
    def get_weights(self) -> tuple:
        if self.debug:
            ...
            with Lock():
                short = int(self.client.response.headers.get(
                    'x-mbx-used-weight-1m', 500))
                long =  int(self.client.response.headers.get(
...
class BinancePublic:
    ...
    def get_ohlcv(self, symbol:str, interval:str, start:Union[int, str]=None,
                  end:Union[int, str]=None, as_dataframe:bool=True) -> list:
    ...
    def get_ohlcv_old(self, symbol:str, interval:str, start:Union[int, str]=None,
                  end:Union[int, str]=None, as_dataframe:bool=True) -> dict:

        # check format of start and end time and convert to seconds,
        # if necessary
        if not isinstance(start, int) or not isinstance(end, int):
            start_ts, end_ts = get_start_and_end_timestamp(start, end, interval,
                                                        unit='seconds',
                                                        verbose=False)
        else:
        ...
        res = self._fetch_ohlcv(symbol=symbol, interval=interval,
    ...
    @call_wrapper(debug=False)
    def _fetch_ohlcv(self, symbol:str, interval:str, start_ts:int=None,
                     end_ts:int=None, limit:int=1000) -> dict:
...
class BinanceSpot:
    ...
    #
    def get_orders(self, symbol:str, side:str=None, order_type=None,
                   status=None, start:Union[int, str]=None,
                   end:Union[int, str]=None, limit:int=1000) -> dict:
    ...
    def get_order(self, symbol:str, order_id:str=None,
        ...
        res = self.client.get_order(symbol=symbol,
                                    orderId=order_id,
    ...
    @call_wrapper(debug=False)
    def get_active_orders(self, symbol:str=None, side:str=None, order_type=None
                          ) -> dict:
        ...
        if orders:
            ...
            if order_type:
                order_type = '_'.join([item.upper() for item
                                       in order_type.split('_')])
                orders = [o for o in orders if o['type'] == order_type]
    ...
    def get_active_stop_orders(self, symbol:str=None, side:str=None) -> dict:
        ...
        stop_types = ['STOP_LOSS_LIMIT', 'STOP_LOSS_MARKET',
    ...
    # .........................................................................
    @call_wrapper(debug=False)
    def _get_all_orders(self, symbol:str=None, start:int=None,
                        end:int=None, limit=1000) -> dict:
    ...
    def sell_all(self, symbol:str) -> dict:
        ...
        if res['success']:
            ...
            if base_qty > 0:
                return self.sell_market(symbol=symbol,
                                        base_qty=base_qty,
    ...
    # .........................................................................
    @call_wrapper(debug=False)
    def buy_market(self, symbol:str, client_order_id:str, base_qty:float=None,
                   quote_qty:float=None, auto_borrow=False,
                   base_or_quote='quote') -> dict:
        ...
        return self.client.order_market_buy(symbol=symbol,
    ...
    @call_wrapper(debug=False)
    def sell_market(self, symbol:str, client_order_id:str, base_qty:float=None,
                    quote_qty:float=None) -> dict:

        return self.client.order_market_sell(symbol=symbol,
                                             newClientOrderId=client_order_id,
                                             quantity=base_qty,
                                             quoteOrderQty=quote_qty,
                                             newOrderRespType='FULL')
    ...
    @call_wrapper(debug=False)
    def buy_limit(self, symbol=None, base_qty=None, price=None,
                  client_oid=None, margin_mode=None, auto_borrow=False,
                  stp=None, remark=None) -> dict:
    ...
    # .........................................................................
    @call_wrapper(debug=False)
    def stop_limit(self, symbol:str, side:str, base_qty:float, stop_price:float,
                   limit_price:float, client_order_id:str,
                   loss_or_entry:str='loss', mode:int=0) -> dict:
    ...
    def cancel_all_orders(self, symbol:str=None):
        ...
        if res['success']:
            ...
            res['message'] = [self._cancel_order_by_order_id(
    ...
    # CREATE order(s)
    @call_wrapper(debug=False)
    def _create_order(self, symbol=None, side=None, remark=None, order_type=None,
                      client_oid=None, stp=None, margin_mode=None,
                      auto_borrow=False, size=None, price=None, funds=None):

        if client_oid is None:
            client_oid = str(uuid1())

        return self.client.create_margin_order(symbol=symbol, side=side.lower(),
                                               order_type=order_type,
                                               remark=remark,
                                               client_oid=client_oid, stp=stp,
    ...
    @call_wrapper(debug=False)
    def _create_stop_limit_order(self, symbol:str=None, side:str=None,
                                 base_qty:float=None, client_oid:str=None,
                                 stop_price:float=None, limit_price:float=None,
                                 loss_or_entry:str='loss',
                                 remark:str=None) -> dict:

        return self.client.create_limit_order(symbol=symbol, side=side,
