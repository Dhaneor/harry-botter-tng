...
class HermesTester:
    ...
    @execution_time
    def get_tradeable_symbols(self, quote_asset: Optional[str]=None, 
    ...
    @execution_time
    def get_ohlcv_multiple(self, symbols:list, start:Union[str, int], 
                           end:Union[str, int]):
    ...
    def get_ohlcv_table_status(self, symbol:str):
        pprint(self.hermes._get_ohlcv_table_status_for_symbol(
            symbol=symbol, interval=self.interval))
    
    @execution_time
    def get_ohlcv_tablename(self, symbol:str, interval:str):
        name = self.hermes._get_ohlcv_tablename(symbol=symbol, 
                                                interval=interval) 
        print(name)
    ...
    def get_listing_date(self, symbol: str, interval: str='1d'):
        ...
        print(
            f'listing date for {symbol} ({interval}): {ld} ({unix_to_utc(ld)})'
        )
    ...
    # -------------------------------------------------------------------------
    @execution_time
    def update_database_for_interval(self, exchange:str, quote_asset:str, 
                                     interval:str):
        print('-'*160)
        self.hermes.update_database_for_interval(exchange=exchange, 
...
if __name__ == '__main__':
    ...
    dates = [-80000, #'January 01, 2019 00:00:00',
